                                    ...
                                    <div class="row related-products">
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ $product->name }}" tabindex="0">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ $product->name }}" tabindex="0">Ulstra Bass Headphone</a></h2>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ $product->name }}" tabindex="0">Smart Bluetooth Speaker</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ $product->name }}" tabindex="0">HomeSpeak 12UEA Goole</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up mb-0">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ $product->name }}" tabindex="0">Dadua Camera 4K 2022EF</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h5><a href="{{ $product->name }}">Chen Cardigan</a></h5>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h6><a href="{{ $product->name }}">Chen Sweater</a></h6>
                                    <p class="price mb-0 mt-5">&#36;{{$product->sale_price}}</p>
                                    <div class="product-rate">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h6><a href="{{ $product->name }}">Colorful Jacket</a></h6>
                                    <p class="price mb-0 mt-5">&#36;{{$product->sale_price}}</p>
                                    <div class="product-rate">
